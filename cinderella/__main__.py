...
SOURCE_STRING = """
⚡I'm built in python3, using the python-telegram-bot library, and am fully opensource - you can find what makes me tick [here](https://github.com/Noobxboy/AZUSA
"""
...
if START_IMG is None:
    img = "https://telegra.ph/file/b45ef890e4c235b336712.gif"
else:
  img = START_IMG    
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="🤝Help",callback_data="help_back"),InlineKeyboardButton(text="🛡Creator🛡",url="https://t.me/HILLARIOUS_X")]]
    keyboard += [[InlineKeyboardButton(text="🌐Support channel",url=https://t.me/Azusasupport"),InlineKeyboardButton(text="⚜️Add Me⚜️",url="t.me/{}?startgroup=true".format(bot.username))]]
